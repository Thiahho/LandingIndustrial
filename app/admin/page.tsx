            ...
            <div className="mx-auto flex w-[min(1200px,92vw)] flex-col gap-4 py-6 md:flex-row md:items-center md:justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-am-muted">
                  Editá textos, imágenes, novedades y recursos sin depender del proveedor.
                </p>
              </div>
          ...
          <div className="mx-auto grid w-[min(1200px,92vw)] gap-6 pt-8 lg:grid-cols-[240px_1fr]">
            ...
            <main className="grid gap-10">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <Link href="/" className="rounded-full border border-white/15 px-4 py-2 text-xs font-bold uppercase tracking-[0.24em] text-am-silver">
                  Ver landing
                </Link>
              </div>
                  ...
                  <article key={`${item.title}-${index}`} className="grid gap-2 rounded-3xl border border-white/10 bg-black/20 p-5">
                    {[
                      ...
                      field.key === "imageUrl" ? (
                        ...
                        <label key={field.key} className="grid gap-1 text-xs font-bold uppercase tracking-[0.2em] text-am-muted">
                          {field.label}
                          <input
                            value={field.value}
            ...
            <section id="permisos" className="grid gap-4 rounded-[28px] border border-am-primary/40 bg-am-primary/10 p-6">
              <div className="space-y-1">
                ...
                <p className="text-sm text-am-muted">Esto comunica claramente el alcance de autogestión para admin y empleado.</p>
              </div>
              <ul className="grid gap-2 md:grid-cols-2">
                {permissionsByRole[user.role].map((item) => (
                  <li key={item} className="rounded-2xl border border-white/10 bg-white/[0.05] px-4 py-3 text-sm font-semibold text-am-silver">
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <section id="publicacion" className="flex flex-wrap items-center justify-between gap-4 rounded-[28px] border border-white/10 bg-[#0c1715]/80 p-6">
              <div className="space-y-1">
                ...
                <p className="text-sm text-am-muted">Los cambios se persisten en el backend .NET y quedan disponibles para la landing.</p>
              </div>
              <button
                type="button"
                onClick={save}
